# xiao_pantilt interference sweep (cover: dome4)

backlash 0.15 mm, 130 poses, struct tolerance 1.0 mm^3, gear tolerance 0.5 mm^3, 574 s
...
| dome4 ceiling clearance (min over envelope) | 3.7 | mm | PASS |
