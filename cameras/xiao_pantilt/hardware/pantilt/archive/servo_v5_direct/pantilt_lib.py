"""xiao_pantilt geometry library — v5 DIRECT-DRIVE pan-only tube version (2026-09-09).
...
servo_floor_clear = 1.0
pan_servo_z0 = servo_floor_clear                         # servo bottom 1 mm above the bench
