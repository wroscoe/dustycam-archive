...
`cameras/common/micropython/meshcore.py` already builds and parses
...
Project: `cameras/openmv_n6/hardware/lora_hat/` — `index.circuit.tsx`,
...
1. **`cameras/common/micropython/sx1262.py`** — minimal SX1262 driver on
...
- MeshCore PHY: `meshcore-dev/MeshCore` `src/helpers/radiolib/` (see §1);
  packet format: `cameras/common/micropython/meshcore.py`.
