...
| plantlogger | `sensors/plantlogger` | built, deployed | 2026-07-21 | FeatherS3 soil logger → sensorhub MQTT (`home/plant/{dev}/…`); live page at :8088/v/plant. Its old standalone server (`sensors/plantlogger/server/`, :8087) is dead and superseded |
